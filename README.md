...
- Header設計：顯示歡迎詞及使用者當日攝取總熱量(攝取-消耗)

- 左側Menu設計：使用該Menu切換功能頁面

- 使用者基本資料：提供使用者修改基本資料

- 餐點輸入：TextBox + ComboBox 選擇常用食物，或手動輸入並記錄新食物

- 每日統計：Label 顯示當日總熱量與營養素

- 活動消耗：ChartControl 折線圖顯示一週趨勢，並可自由切換日期
